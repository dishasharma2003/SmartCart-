            ...
            <div className='max-w-lg w-full bg-white shadow-xl rounded-2xl p-8 border border-orange-100'>
                <div className='flex flex-col items-center mb-6'>
                    <div className='bg-orange-100 p-4 rounded-full mb-4'>
                        <FaShop className='text-[#ff4d2d] w-16 h-16' />
                    </div>
                ...
                <form className='space-y-5' onSubmit={handleSubmit}>
                    ...
                    <div>
                        <label className='block text-sm font-medium text-gray-700 mb-1'>Select Item Type</label>
                        <select className='w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500'
                            onChange={(e) => setFoodType(e.target.value)}
                            value={foodType}

                        >
                            <option value="veg" >Breakable</option>
                            <option value="non veg" >UnBreakeable</option>
                        </select>
                    </div>
